...
import {
  ...
  PlayCircle, Lock, KeyRound, Settings,
} from "lucide-react";
    ...
    <div className="min-h-screen bg-slate-100 flex flex-col">
      <div className="bg-slate-900 px-5 pt-6 pb-8 rounded-b-3xl shadow-md">
        ...
        <div className="mt-5">
          ...
          <div className="text-white text-2xl font-black tracking-tight mt-0.5">
              ...
              {filtrados.map((r) => {
                ...
                return (
                  <tr key={r.id} className="hover:bg-slate-50">
                    ...
                    <td className="px-3 py-2.5"><button onClick={() => abrirEdicao(r)} className="text-slate-400 hover:text-amber-600"><Pencil className="w-4 h-4" /></button></td>
                  </tr>
                );
              })}
